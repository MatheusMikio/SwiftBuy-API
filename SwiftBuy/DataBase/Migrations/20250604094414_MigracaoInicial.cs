...
namespace SwiftBuy.Migrations
{
    ...
    public partial class MigracaoInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProdutoModelPromocaoModel",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProdutoModelPromocaoModel", x => new { x.ProdutosId, x.PromocoesId });
                    table.ForeignKey(
                        name: "FK_ProdutoModelPromocaoModel_produtos_ProdutosId",
                        column: x => x.ProdutosId,
                        principalTable: "produtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProdutoModelPromocaoModel_promocoes_PromocoesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdutoModelPromocaoModel_PromocoesId",
                table: "ProdutoModelPromocaoModel",
                column: "PromocoesId");
